...
<template>
  <div class="wrap">
    <div class="title_wrap">
      <div class="title_style">学生学习统计</div>
            ...
            return h(
              ...
              [
                h("div", {
                  ...
                  domProps: {
                    innerHTML: params.row.finishTerm
                  }
                }),
                h("div", {
                  style: {
  ...
  methods: {
    ...
    */
    addSubjectExport(){
      ...
      window.location.href =
        nozzle.statisticsCtrl.exportStuStatistics +
        "?orderWay=" +
    ...
    */
    loadinfoDataAjax(_data) {
      var _this = this;
      window.loadingView.show("studentAnalysisList");
      window.util.ajax
        .get(nozzle.statisticsCtrl.stuStatistics, {
          params: _data
        })
        .then(function(res) {
          ...
          ajaxInterface
            ...
            .autoRun("login", "error", "studentAnalysisList");
        })
        .catch(function(error) {
          window.util.checkAjaxError(error).autoRun("studentAnalysisList");
        });
    }
  },
  mounted() {
